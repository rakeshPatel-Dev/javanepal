...
const testimonials = [
  { name: "Aayush Koirala", role: "BITM Student", quote: "JavaNepal helped me go from struggling with OOP concepts to confidently answering viva questions. The unit-wise structure made revision so much easier before exams.", initials: "AK", color: "bg-blue-500", link: "https://np.linkedin.com/in/aayush-koirala" },
  ...
  { name: "Roshan Gurung", role: "BITM Student", quote: "JavaNepal is the perfect study companion for BITM students. The MCQ and theory question bank is exactly what we need for semester exams.", initials: "RG", color: "bg-amber-500", link: "https://np.linkedin.com/in/roshan-gurung" },
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground text-sm mt-2 max-w-lg mx-auto">Hear from fellow students who transformed their Java OOP preparation with JavaNepal</p>
        </div>
